def find_greatest_product(grid):
    ...
    for r in range(rows):
        for c in range(columns):
            ...
            #from up or down
            if r + 3 < rows:
                product = grid[r][c] * grid[r + 1][c] * grid[r + 2][c]
                max_product = max(max_product, product)
            ...
            #diagonally
            if r + 3 < rows:
                product = grid[r][c] * grid[r + 1][c - 1] * grid[r + 2][c - 2] * grid[r + 3][c - 4]
                max_product = max(max_product, product)
...
print(find_greatest_product(grid)) #output should be 70600674
